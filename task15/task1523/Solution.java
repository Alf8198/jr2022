...
public class Solution {
    ...
    Solution(){System.out.println("инициализация конструктора Solution");}
    public Solution(int i){System.out.println("инициализация конструктора Solution");}
    protected Solution(double i){System.out.println("инициализация конструктора Solution");}
    private Solution(short i){System.out.println("инициализация конструктора Solution");}
}
